...
public class MP_QM_RDI_Pricing_Validation_ON_NET_Test extends Base {
	/** POC Test for RDI products
	 * @throws Exception
	 */
	@Test(dataProvider = "PBFAgentData")
	public void test_validate_PBF_RDI_ON_NET_PriceValidation_EPC_Release(Hashtable<String, String> dataTable) throws Exception {
		int rowStart = 1; int rowNum = 0;int rowNext = 0; int count = 0;
        ...
        outerloop:
			while (true) {
				InputData_QM.setDataFor_QM_RDI(Constants.PBF_AGENT_SHEET_RDI_PRICE_VALIDATION_ON_NET, rowNum, reader);	
			...
			rowNext = 	rowNum +1;
			InputData_QM.runMode = reader.getCellData(Constants.PBF_AGENT_SHEET_RDI_PRICE_VALIDATION_ON_NET, "RunMode", rowNext);
			rowNum ++;
	...
	public Object[][] PBFAgentData() throws IOException {
		return getDataSetsRunMode(Constants.TESTDATA_COMM_PRICING_VALIDATION_FILE, Constants.PBF_AGENT_SHEET_RDI_PRICE_VALIDATION_ON_NET);
	}
}
