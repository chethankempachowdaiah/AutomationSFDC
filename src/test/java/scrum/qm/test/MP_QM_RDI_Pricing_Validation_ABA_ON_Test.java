...
public class MP_QM_RDI_Pricing_Validation_ABA_ON_Test  extends Base {

	/** POC Test for RDI products
	 * @throws Exception
	 */
	@Test(dataProvider = "PBFAgentData")
	public void test_validate_PBF_RDI_ABA_ON_Promo_PriceValidation_EPC_Release(Hashtable<String, String> dataTable) throws Exception {
        ...
        outerloop:
			while (true) {
				InputData_QM.setDataFor_QM_RDI(Constants.PBF_AGENT_SHEET_RDI_PRICE_VALIDATION_ABA_ON, rowNum, reader);	
			...
			rowNext = 	rowNum +1;
			InputData_QM.runMode = reader.getCellData(Constants.PBF_AGENT_SHEET_RDI_PRICE_VALIDATION_ABA_ON, "RunMode", rowNext);
			rowNum ++;
	...
	public Object[][] PBFAgentData() throws IOException {
		return getDataSetsRunMode(Constants.TESTDATA_COMM_PRICING_VALIDATION_FILE, Constants.PBF_AGENT_SHEET_RDI_PRICE_VALIDATION_ABA_ON);
	}
}
