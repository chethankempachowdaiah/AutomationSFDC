...
public class Regression_ServiceEnab_TC13_ValidateACRPermissionBusinessContactManageRelationshipRoleSA_Test extends Base 
{	
	@Test
	public void test_ValidateACRPermissionBusinessContactManageRelationshipRoleSA() throws Exception 
	{
...
//		sfdc.contacts.searchContactFromGlobalSearch(Global.dataInput.contactName);
		...
		sfdc.accRelated.validateRelationshipContactBillingServiceAccountForACRPermission(true);		
		sfdc.home.closeTabIfOpen();
		sfdc.home.logout();
