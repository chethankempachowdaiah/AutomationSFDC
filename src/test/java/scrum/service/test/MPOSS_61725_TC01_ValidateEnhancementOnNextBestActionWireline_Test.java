...
/**
 * @author Robin.Mangla, Date: 12/APR/2022
 * 
 *         Validate Enhancement on next best action component
 * 
 *   
 */
public class MPOSS_61725_TC01_ValidateEnhancementOnNextBestActionWireline_Test extends Base {
	 ...
	 */
	@Test(groups= {"sanity"})
	public void test_ValidateEnhancementOnNextBestActionWireline() throws IOException, InterruptedException {
...
//		sfdc.home.logout();
		...
		sfdc.cases.createCaseProactivelyForSubscription(true);
		sfdc.caseDetails.validate_ProactivelyCreatedCaseDetailsForSubscription(true);
		sfdc.caseDetails.validateNextBestAction(true);		
		sfdc.home.closeTabIfOpen();
		sfdc.home.logout();
