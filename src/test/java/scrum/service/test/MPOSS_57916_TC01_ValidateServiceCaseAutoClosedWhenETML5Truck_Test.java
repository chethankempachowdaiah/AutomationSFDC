...
/**
 * @author Robin.Mangla, Date: 18/MAR/2022
 * 
 *         User Creates a ETM case from existing customer case
 * 
 *   
 */
public class MPOSS_57916_TC01_ValidateServiceCaseAutoClosedWhenETML5Truck_Test extends Base {

	/**
	 * @throws IOException
	 * @throws InterruptedException
	 * 
	 * 	 	                       Validate that service case is auto closed when
	 *                             
	 ...
	 */
	@Test(groups= {"sanity"})
	public void test_ValidateServiceCaseAutoClosedWhenETML5Truck() throws IOException, InterruptedException {
...
//		sfdc.home.logout();
		...
		sfdc.home.closeTabIfOpen();
		sfdc.caseDetails.searchCaseFromGlobalSearch(InputData.caseNumber);
		sfdc.caseDetails.validateETMStatusAndBellNotification(true);
		sfdc.home.closeTabIfOpen();
		sfdc.home.logout();
