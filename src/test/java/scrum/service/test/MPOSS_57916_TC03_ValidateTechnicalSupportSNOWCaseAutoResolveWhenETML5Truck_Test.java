 ...
 *   
 */
public class MPOSS_57916_TC03_ValidateTechnicalSupportSNOWCaseAutoResolveWhenETML5Truck_Test extends Base {

	/**
	 * @throws IOException
	 * @throws InterruptedException
	 * 
	 * 	 	                       Validate that technical support SNOW is auto resolved when
	 *                             
	 ...
	 */
	@Test(groups= {"sanity"})
	public void test_ValidateTechnicalSupportSNOWCaseAutoResolveWhenETML5Truck() throws IOException, InterruptedException {
...
//		sfdc.home.logout();
		...
		sfdc.caseDetails.validateProactivelyCreatedSNOWCaseDetails();	
