...
public class WA_TC_64_DeviceShopCartEnhancement_PlanFirst_Test extends MyListener{
	...
	// Test Case is for US WACC-2127
	@Test(dataProvider = "getDataPlan")
	public void validate_FinacedDevice_OnShoppingCartPage_PlanFirst(Hashtable<String, String> dataTable) throws Exception {
		...
		sfdc.shopCart.verify_PricePlanFirst();
		
		//Click on Show More Details for seeing finance term of device
		sfdc.shopCart.clickShowMoreDetails("with 24 month financing");
		
		//To verify Discounted and Original Price of device
		sfdc.shopCart.verify_DiscountDevices();
	}	
	...
	// Test Case is for US WACC-2127
	@Test(dataProvider = "getDataPlan")
	public void validate_ChangingDevice_PricePlan_Qty_OnShppingCartPage(Hashtable<String, String> dataTable) throws Exception {
		sfdc = new SFDC_AllPages();
		sf = new SFDC_AllPageObjects();
		test = reports.createTest(this.getClass().getName());
		InputData_WA.setDataForWACCProducts(dataTable);	
