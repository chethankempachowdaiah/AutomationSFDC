...
public class WA_TC_72_Verify_QuotePDFEnhancement_Test extends MyListener {
	SFDC_AllPages sfdc;
	SFDC_AllPageObjects sf;

	// Test Case is for US WACC-4279
	@Test(dataProvider = "getDataPlan")
	public void validate_PooledPDFEnhancement(Hashtable<String, String> dataTable) throws Exception {
		...
		sfdc.selectPro.selectDataPlanAndType(InputData_WA.WACC_Data_Type, "Pooled",InputData_WA.WACC_Plan_Size );
		...
		//Verify cart details
		sfdc.shopCart.verifyCartDetails(InputData_WA.WACC_Plan_Size, InputData_WA.WACC_Plan_Price, "Pooled", InputData_WA.WACC_AddOn_Name, InputData_WA.WACC_AddOn_Price );
		...
		sfdc.reOrder.validate_text_InPDF("Pooled",Constants.DOWNLOADS_LOCATION +"Proposal.pdf" );
		sfdc.reOrder.validate_text_InPDF("Quantity",Constants.DOWNLOADS_LOCATION +"Proposal.pdf" );
		...
		sfdc.reOrder.select_DownloadOrderSummary_button();
		sfdc.reOrder.validate_text_InPDF("Pooled",Constants.DOWNLOADS_LOCATION +"Agreement.pdf");
		sfdc.reOrder.validate_text_InPDF("Quantity",Constants.DOWNLOADS_LOCATION +"Agreement.pdf" );
		sfdc.reOrder.select_BackToReviewOrder_button();
		...
		sfdc.reOrder.validate_text_InPDF("Pooled",Constants.DOWNLOADS_LOCATION+"Agreement_for_your_DocuSign_Signature.pdf" );
		sfdc.reOrder.validate_text_InPDF("Quantity",Constants.DOWNLOADS_LOCATION +"Agreement_for_your_DocuSign_Signature.pdf" );
}
	// Test Case is for US WACC-4279
	@Test(dataProvider = "getDataPlan")
	public void validate_StandalonePDFEnhancement(Hashtable<String, String> dataTable) throws Exception {
		sfdc = new SFDC_AllPages();
		sf = new SFDC_AllPageObjects();
		test = reports.createTest(this.getClass().getName());
		InputData_WA.setDataForWACCProducts(dataTable);
		...
		sfdc.selectPro.verifyWirelessProducts();		
		sfdc.selectPro.selectDataPlanAndType(InputData_WA.WACC_Data_Type, "Standalone",InputData_WA.WACC_Plan_Size );
		sfdc.selectPro.continueToAddOnsButton();
		sfdc.selectAddOn.selectAddOn(InputData_WA.WACC_AddOn_Type, InputData_WA.WACC_AddOn_Name,InputData_WA.WACC_AddOn_Availability);
		sfdc.selectAddOn.clickOnContinueToDevice();
		sfdc.shopWADevcs.selectWirelessDevice(InputData_WA.WACC_DeviceBrand, InputData_WA.WACC_DeviceName,"PostWirelessPlans");
		...
		//Verify cart details
		sfdc.shopCart.verifyCartDetails(InputData_WA.WACC_Plan_Size, InputData_WA.WACC_Plan_Price, "Standalone", InputData_WA.WACC_AddOn_Name, InputData_WA.WACC_AddOn_Price );
		sfdc.shopCart.verify_MonthlyProductName_Price(InputData_WA.WACC_DeviceName, InputData_WA.WACC_DeviceCost, 1);		
		sfdc.shopCart.validate_DPName_Price(InputData_WA.WACC_DeviceProtectionName, InputData_WA.WACC_DeviceProtectionCost,1);
		...
		PDFHelper.deletefile_IfExist(Constants.DOWNLOADS_LOCATION +"Proposal.pdf");
		sfdc.reOrder.select_DownloadOrderSummary_button();
		sfdc.reOrder.validate_text_InPDF("Standalone",Constants.DOWNLOADS_LOCATION +"Proposal.pdf" );
		sfdc.reOrder.validate_text_InPDF("Quantity",Constants.DOWNLOADS_LOCATION +"Proposal.pdf" );
		sfdc.reOrder.select_EmailQuoteSummary_button();
		sfdc.reOrder.select_BackToReviewOrder_button();
		...
		PDFHelper.deletefile_IfExist(Constants.DOWNLOADS_LOCATION +"Agreement.pdf");
		sfdc.reOrder.select_DownloadOrderSummary_button();
		sfdc.reOrder.validate_text_InPDF("Standalone",Constants.DOWNLOADS_LOCATION +"Agreement.pdf");
		sfdc.reOrder.validate_text_InPDF("Quantity",Constants.DOWNLOADS_LOCATION +"Agreement.pdf" );
		sfdc.reOrder.select_BackToReviewOrder_button();
		...
		PDFHelper.deletefile_IfExist(Constants.DOWNLOADS_LOCATION +"Agreement_for_your_DocuSign_Signature.pdf");
		sfdc.mailinatorPage.reviewAndDownloadInEmailAtMailinator(InputData_WA.siteContactEmailId);
		sfdc.reOrder.validate_text_InPDF("Standalone",Constants.DOWNLOADS_LOCATION+"Agreement_for_your_DocuSign_Signature.pdf" );
		sfdc.reOrder.validate_text_InPDF("Quantity",Constants.DOWNLOADS_LOCATION +"Agreement_for_your_DocuSign_Signature.pdf" );
}
