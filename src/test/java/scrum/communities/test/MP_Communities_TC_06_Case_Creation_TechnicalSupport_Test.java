 ...
 * 
 */
public class MP_Communities_TC_06_Case_Creation_TechnicalSupport_Test extends BaseDataProvider {
	 ...
	 * 
	 */
	@Test(dataProvider = "caseCreationDataTechnicalSupport")
	public void test_communities_case_creation(Hashtable<String, String> dataTable) throws IOException, InterruptedException {
		...
		if (InputData_Communities.commCaseDoSalesForceValidations.equalsIgnoreCase("Yes")) {
			...
			sfdc.caseDetails.verifyCaseCategory();
			sfdc.comLogin.loginToCommunities();
		}
	 ...
	 */
	@DataProvider
	public Object[][] caseCreationDataTechnicalSupport() throws IOException {
