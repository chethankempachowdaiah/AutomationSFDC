...
public class MACD_TC_09_WACC3932_Verify_AddDisplayValidAddOns_Test extends MyListener {
	SFDC_AllPages sfdc;
	SFDC_AllPageObjects sf;
	
	//Test Case is for US  WACC-3932
	@Test(dataProvider = "getDataPlan")
	public void validate_AddDisplayValidAddOns(Hashtable<String, String> dataTable) throws Exception {
		...
		sfdc.macdSelAddon.validate_ContinueToDateSelection();
