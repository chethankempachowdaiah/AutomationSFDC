...
public class MP_OM_RDI_FreezeOrder_Reinstate_Order_Test extends BaseBrowser {
	/**
	 * @param dataTable
	 * @throws IOException
	...
	public void test_Validate_OM_RDI_FreezeOrder_Reinstate_Order(Hashtable<String, String> dataTable)
