 ...
 *Mar. 14, 2022
 * MP26
 * US Stories : 4045, 2741
 */
public class WA_TC_33_2741_VerifynewPlan_AddedInCart_submit_Test extends MyListener {
	SFDC_AllPages sfdc;
	SFDC_AllPageObjects sf;

	// Test Case is for US WACC-2741 
	@Test(dataProvider = "getDataPlan")
	public void Validate_newPlanAdded_Term_Submit(Hashtable<String, String> dataTable,Method method) throws Exception {
		...
		sfdc.selectPro.clicknAddToCartBtnForDP();
		  ...
		  sfdc.bAccessories.clickOnAccessoriesViewDetailsBtn("All accessories",InputData_WA.WACC_AccessoryName);
	...
	// Test Case is for US WACC-2741
	@Test(dataProvider = "getDataPlan")
	public void Validate_newPlanAdded_NoTerm_Submit(Hashtable<String, String> dataTable,Method method) throws Exception {
		sfdc = new SFDC_AllPages();
		sf = new SFDC_AllPageObjects();
		test = reports.createTest(this.getClass().getName()+"_"+method.getName());
		InputData_WA.setDataForWACCProducts(dataTable);
		...
		sfdc.quoteRelated.clickOnOrderNoFromQuote();
		sf.seleU.clickElementByJSE(sf.qr.orderNameLinkInInQuoteRelated1);
		sfdc.orderDetails.verifyCreatedOrderInOrderDetailsTab(Global.dataInput.quoteStatusAccepted);
