...
/**
 * @author priyanka.acharya, Date 10/Mar/2020
 * 
 *         Verify Activation of an order with new contact in Opportunity with
 *         On-Net Serviceability with existing Service Account_Ignite
 *         Product_Ontario Region
 *
 */
public class MP_TC_05_E2E_NewCont_ExistingSA_ExistingSiteCon_Ignite_Monthly_ON_Test extends Base {
	 ...
	 * 
	 *                   Create opportunity with new contact and existing Service
	 *                   Contact
	 * 
	 *                   Create Quote Shell
	 * 
	 *                   Add Ignite Product with a Monthly Contract Term
	 * 
	 *                   Configure the Quote and Create Order (Existing Site
	 *                   Contact)
	 * 
	 *                   Activate the Order successfully.
	 */
	@Test
	public void test_OrderActivation_NewContact_ExistingSA_ExistingSiteContact_Ignite_Monthly_ON() throws Exception {
