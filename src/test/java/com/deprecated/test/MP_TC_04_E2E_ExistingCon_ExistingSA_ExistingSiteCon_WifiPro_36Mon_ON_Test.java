...
/**
 * @author priyanka.acharya, Date : 09/March/2020
 * 
 *         Verify Activation of an order with existing contact in Opportunity
 *         with On-Net Serviceability with existing Service Account_Business
 *         Internet Wifi Pro Product_Ontario Region
 *
 */
public class MP_TC_04_E2E_ExistingCon_ExistingSA_ExistingSiteCon_WifiPro_36Mon_ON_Test extends Base {
	 ...
	 * 
	 *                   Create opportunity with existing contact and existing
	 *                   Service Contact
	 * 
	 *                   Create Quote Shell
	 * 
	 *                   Add Business Internet Wifi Pro Product with a 36 months
	 *                   Contract Term
	 * 
	 *                   Configure the Quote and Create Order (Create New Site
	 *                   Contact)
	 * 
	 *                   Activate the Order successfully.
	 */
	@Test
	public void test_OrderActivation_ExistingContact_ExistingSA_ExistingSiteContact_BusinessInternetWifiPro_36Months_ON()
			throws Exception {
