...
/**
 * @author priyanka.acharya, Date 26/FEB/2020
 *
 *         Verify Activation of an order with existing Contact in
 *         Opportunity_Business Internet Product_Ontario Region
 */
public class MP_TC_01_E2E_ExistingCon_ExistingSA_ExistingSiteCon_BusInt_Monthly_ON_Test extends Base {
	 ...
	 */
	@Test
	public void test_OrderActivation_ExistingContact_ExistingSA_ExistingSiteContact_BusinessInternet_Monthly_ON()
			throws Exception {
		...
		sfdc.oppDetails.validateOpportunityDetails(Global.dataInput.businessAccountName);
