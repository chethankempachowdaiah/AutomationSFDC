 ...
 * 
 *         Verify Order Cancellation after task 2 failed
 * 
 *         MP Release Regression_OM_TC04_Validation of cancellation of order
 *         after Task 2 is failed_Ontario
 *
 */

public class MP_OM_TC_01_Validation_Order_Cancellation_After_Task2_Failed_ON_Test extends Base {

	/**
	 * @author Anukriti.Chawla
	 * 
	 * 
	 *         ///// MP Release Regression_OM_TC04_Validation of cancellation of
	 *         order after Task 2 is failed_Ontario
	 * 
	 ...
	 * 
	 *         Click on Next, Enter the 12 digit super system CAN, 7 Digit work
	 *         Order Number, 9 Digit V21 BAN and click on complete.
	 * 
	 *         From Manual queues page, select 'Service Delivery Queue'.
	 * 
	 *         Click On "Assign to Me" and then Fail the Task.
	 * 
	 *         Search the Order through AE Profile.
	 * 
	 *         Verify the Status of the Order and then Click on "Cancel".
	 * 
	 *         Log in as Service Delivery
	 * 
	 *         Go to Service Delivery Queue validate order Status
	 * 
	...
	public void test_OrderCancellation(Hashtable<String, String> dataTable) throws Exception {
		...
		// ***************Create Opportunity***********************//
		// sfdc.accDetails.searchBusAccGlobalSearch("UAT-DaveB-ON-3");
		/*
		...
		// ***************Verify Orchestration plan is complete ********//
		sfdc.orderRelated.verifyOrchestrationPlanInOrder();
	...
	public Object[][] getTestData_TaskFail_OrderCancel_GBJ() throws IOException {
		return getDataSetsRunMode(Constants.MP_TESTDATA_FILE, Constants.GBJ_TASKFAIL_ORDERCANCEL_ON_SHEET);
	}
}
