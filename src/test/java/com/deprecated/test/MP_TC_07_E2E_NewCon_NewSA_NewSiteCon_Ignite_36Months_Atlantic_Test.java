 ...
 *         Opportunity_Atlantic Region
 *
 */
public class MP_TC_07_E2E_NewCon_NewSA_NewSiteCon_Ignite_36Months_Atlantic_Test extends Base {
	 ...
	 * 
	 * Create opportunity with the Business Account with new Service Account and new
	 * contact
	 * 
	 * Create Quote Shell
	 * 
	 * Add Ignite Product with a 36 months Contract Term
	 * 
	 ...
	 */
	@Test
	public void test_OrderActivation_NewContact_NewSA_NewSiteContact_Ignite_36Months_Atlantic() throws Exception {
