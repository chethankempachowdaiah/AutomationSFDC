...
public class WA_TC_03_Verify_FraudCheck_Order_Approval_Scrape_Test extends BaseDataProvider {
	/**
	 * @author Sakshi.Lnu
	 * @Date 05-May-2021
	 ** @param dataTable
	...
	public void test_verifyWirelessPlansAndAddToCart(Hashtable<String, String> dataTable) throws Exception {
		...
		sfdc.accDetails.searchAccountFromGlobSearch(InputData.account_ATL, "Business");
		sfdc.accRelated.createOpportunity();
		sfdc.cOpp.enterWirelessOpportunityDetails();
		sfdc.cOpp.selecetExistingContactInOpportunity(InputData_WA.contact_Business_R4B_ATL);
