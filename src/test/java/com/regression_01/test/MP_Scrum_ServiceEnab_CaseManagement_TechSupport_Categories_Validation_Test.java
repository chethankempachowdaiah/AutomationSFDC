...
public class MP_Scrum_ServiceEnab_CaseManagement_TechSupport_Categories_Validation_Test extends BaseDataProvider {
	 ...
	 * 
	 *                     2. Select cases and create new case of Tech support
	 *                     category
	 */
	@BeforeTest
	 ...
	 * @throws Exception
	 * 
	 *                   Select and verify values present in category dropdown as
	...
	public Object[][] getCaseManagementCategories() throws IOException {
		if (InputData.frenchEnabled.equals("Yes")) {
			return getDataSets(Constants.CASE_MANAGEMENT_CATEGORIES_FILE_FRENCH, Constants.TECH_SUPPORT_SHEET);

		} else {
			return getDataSets(Constants.CASE_MANAGEMENT_CATEGORIES_FILE, Constants.TECH_SUPPORT_SHEET);
